...
public interface UserService {
     ...
     *
     * @param pageable the pagination parameters including page number, size, and
     *                 sorting criteria
     */
     ...
     *
     * <p>
     * This method processes the user creation request, validates the input data,
     ...
     *
     * <p>
     * This method updates the user's profile information based on the provided
     * request. Only non-null fields in the request will be updated.
     * </p>
     *
     ...
     *
     * <p>
     * This operation performs a soft or hard delete based on the application
     * configuration. Related data may be handled according to cascade rules.
     * </p>
     *
     * @param id the unique identifier (UUID) of the user to delete
     * @throws com.congty9a4.backend.exception.error.AppException if the user is not
     *                                                            found
     ...
     * statistics, and other related data encapsulated in the Infochan entity.
     * </p>
     *
     ...
     *
     * <p>
     * This method toggles the follow status between the currently authenticated
     * user
     * and the target user specified by the ID. If the current user is already
     * following
     * the target user, this will unfollow them. Otherwise, it will create a new
     * follow
     * relationship.
     * </p>
     *
     * @param targetUserId the unique identifier (UUID) of the user to follow or
     *                     unfollow
     * @throws com.congty9a4.backend.exception.error.AppException if the target user
     *                                                            is not found
     *                                                            or if the user
     *                                                            attempts to follow
     *                                                            themselves
